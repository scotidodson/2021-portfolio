  ...
  return (
   <div className='resume'>
     ...
     <div className='resume__segment'>
      ...
      <h2><a href="https://www.mna.co/" target="_blank" rel="noreferrer">MINDS + ASSEMBLY</a></h2>
     ...
     <div className='resume__segment'>
      ...
      <h2><a href="https://www.flatironschool.com/" target="_blank" rel="noreferrer">FLATIRON SCHOOL</a></h2>
